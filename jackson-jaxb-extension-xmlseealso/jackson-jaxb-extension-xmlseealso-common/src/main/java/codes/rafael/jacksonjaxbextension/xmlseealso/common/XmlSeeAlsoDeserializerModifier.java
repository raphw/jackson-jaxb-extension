...
class XmlSeeAlsoDeserializerModifier extends BeanDeserializerModifier {
    ...
    public XmlSeeAlsoDeserializerModifier(PropertyName property, Function<String, PropertyName> resolver, Function<BeanDescription, Map<PropertyName, Class<?>>> toTypes) {
